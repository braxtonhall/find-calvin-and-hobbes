 ...
 *
 * A site mounted below the root — a GitHub project page — gets no `CNAME` either: a custom domain
 * would serve it from the root, and `user.github.io` in the file is a domain GitHub refuses.
 */
